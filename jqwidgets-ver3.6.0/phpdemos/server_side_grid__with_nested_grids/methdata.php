...
$tab1 = 'meth_view';//Customers
$tab2 = 'meth_view'; //Orders
...
if (isset($_GET['pub_id']))
{
	...
	$query = "SELECT SQL_CALC_FOUND_ROWS * FROM " . $tab2 . " WHERE pub_id='" .$_GET['pub_id'] . "'";
   ...
   $filterquery = "";
	...
	if (isset($_GET['filterscount']))
	{
		...
		{
			// $where = " WHERE (";
			$where = " WHERE pub_id='" .$_GET['pub_id'] . "' AND (";
			$tmpdatafield = "";
			$tmpfilteroperator = "";
		...
		if ($sortorder != '')
		{
			if ($_GET['filterscount'] == 0)
			{
				if ($sortorder == "desc")
				{
					...
					$query = "SELECT distinct * FROM $tab2 WHERE pub_id = '" . $_GET['pub_id'] . "' ORDER BY" . " " . $sortfield . " DESC LIMIT $start, $pagesize";
				}
				else if ($sortorder == "asc")
				{
					$query = "SELECT * FROM $tab2 WHERE pub_id = '" . $_GET['pub_id'] . "' ORDER BY" . " " . $sortfield . " ASC LIMIT $start, $pagesize";
				}
